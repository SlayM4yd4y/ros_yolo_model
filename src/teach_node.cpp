...
void YOLOTrainer::start_training(const std::string& data_yaml, const std::string& model_output_path) {
    ...
    std::string command = "python3 /home/ajr/ros2_ws/src/yolov5/train.py --img 640 --batch 16 --epochs 40 --data " + data_yaml + 
                          " --weights /home/ajr/ros2_ws/src/ros_yolo_model/output_model_fine/weights/best.pt --cache --name " + model_output_path + " --hyp /home/ajr/ros2_ws/src/ros_yolo_model/ext_dataset/hyp.yaml";
